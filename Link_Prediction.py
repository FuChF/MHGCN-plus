...
# from node_classfication_evaluate import node_classification_evaluate
...
if args.dataset == 'amazon':
    ...
    try:
        ...
        pass
    feature = torch.FloatTensor(np.array(feature.todense())).float()
...
# print(A[0][0])
# print('//////////////////////////////////////////////////////////////////////')
# model = get_model(args.model, feature.size(1),  A, args.hidden, args.out, args.dropout, False)
